...
public class GetTime extends AsyncTask<String,Void,String> {
    ...
    public GetTime(AsyncResponse delegate, String origin, String desti) {
    ...
    protected String doInBackground(String... params) {
        String result_url = "https://maps.googleapis.com/maps/api/directions/json?origin="+origin+"&destination="+desti+"&key=" + key;
        String post_data;
